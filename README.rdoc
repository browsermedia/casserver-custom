...
See the LICENSE.txt file bundled with the official RubyCAS-Server distribution for details.


== BrowserMedia
See Installation instructions for Passenger in 'Install_for_Passenger.txt'.